...
class SideBar(models.Model):
    ...
    content = models.CharField(max_length=1000, blank=True, verbose_name="内容",
    ...
    def content_html(self):
        ...
        if self.type == self.DisplayType.HTML:
            ...
            context = {
                'articles': Article.hottest_articles()
            }
